    ...
    <footer className="bg-dark-brown text-beige">
      <div className="mx-auto max-w-7xl px-5 py-12 md:px-8 md:py-16">
        <div className="grid gap-10 md:grid-cols-3 md:gap-8">
          ...
          <div>
            <h3 className="font-serif text-sm font-bold uppercase tracking-widest text-white">{t.footerNav}</h3>
            <ul className="mt-4 flex flex-col gap-3">
              {navLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-beige/80 transition-colors duration-200 hover:text-gold">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h3 className="font-serif text-sm font-bold uppercase tracking-widest text-white">{t.footerContact}</h3>
        ...
        <div className="mt-6 flex flex-col items-center gap-4 md:flex-row md:justify-between">
          <p className="text-xs text-beige/60">{t.footerRights}</p>
          <div className="flex items-center gap-5">
            {/* Instagram */}
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gold transition-colors duration-200 hover:text-gold-light">
            ...
            {/* Facebook */}
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gold transition-colors duration-200 hover:text-gold-light">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
                <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
              </svg>
            </a>
            {/* LinkedIn */}
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-gold transition-colors duration-200 hover:text-gold-light">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
