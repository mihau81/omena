    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-5 md:px-8">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3 md:gap-8">
            {featuredAuctions.map((auction) => (
              ...
              >
                <div className="aspect-[4/3] rounded-lg bg-beige transition-transform duration-300 group-hover:scale-[1.02]" />
                <div className="mt-4">
          ...
          <div className="mt-10 text-center">
            <Link
              href="/auctions"
              className="inline-flex items-center gap-2 text-sm font-medium text-gold transition-colors duration-200 hover:text-gold-dark"
            >
      ...
      <section className="bg-gold py-16 md:py-24">
        <div className="mx-auto max-w-7xl px-5 text-center md:px-8">
          ...
          <Link
            href="/contact"
            className="mt-8 inline-block rounded-full border-2 border-white px-8 py-3 text-sm font-medium text-white transition-colors duration-200 hover:bg-white hover:text-gold"
          >
